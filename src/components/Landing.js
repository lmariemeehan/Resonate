    ...
    {/*Sellings Points*/}
      ...
      <div className="sellingpoints-container">
        ...
        <div className="selling-point-1" >
          <img src="/assets/images/landing_page/vinyl-records-945396_1920.jpg" width="500" height="400" alt="" />
        ...
        <div className="selling-point-2" >
          ...
          <img src="/assets/images/landing_page/bodybuilder-925770_1920.jpg" width="500" height="400" alt="" />
        </div>

        <div className="selling-point-3" >
          <img src="/assets/images/landing_page/mobile_adults.jpg" width="500" height="400" alt="" />
          <div className="selling-descriptions">
